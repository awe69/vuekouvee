                    ...
                    <v-card>
                      ...
                      <v-card-text>
                        <v-container>
                          <v-row>
                            <v-col cols="12">
                              <v-text-field color="blue" label="ID Transaksi Produk" v-model="form2.id_transaksi_produk"
                                required></v-text-field>
                            </v-col>
                            <v-col cols="12">
                              <v-autocomplete item-value="ID_PRODUK" item-text="ID_PRODUK" label="ID PRODUK"
                                v-model="form2.id_produk" :items="listItem">
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Total Transaksi Produk', value: 'TOTAL_TRANSAKSI_PRODUK',sortable: false },
      { text: 'Diskon Produk', value: 'DISKON_PRODUK',sortable: false },
    ...
    headers2: [
      ...
      { text: 'ID Detail Transaksi Produk', value: 'ID_DETIL_TRANSAKSI',sortable: false },
      { text: 'ID Transaksi Produk', value: 'ID_TRANSAKSI_PRODUK',sortable: true},
      { text: 'ID Produk', value: 'ID_PRODUK',sortable: true },
      { text: 'Nama Produk', value: 'NAMA_PRODUK',sortable: true },
      { text: 'Harga Jual', value: 'HARGA_JUAL',sortable: true },
      { text: 'Jumlah Produk', value: 'JUMLAH_PRODUK',sortable: true },
      { text: 'Subtotal Produk', value: 'SUB_TOTAL_PRODUK',sortable: true },
      { text: 'Action', value: 'action',sortable: false },
    ],
